...
def create_regions(world, options: ParadiseKillerOptions):
    ...
    # Beach
    key_item_name = PK_KEY_ID_TO_NAME[KEY_B]
    if options.enable_mapping_requirements == 1:
    ...
    # Citizen Apartments
    key_item_name = PK_KEY_ID_TO_NAME[KEY_CA]
    if options.enable_mapping_requirements == 1:
    ...
    # Citizen Housing
    key_item_name = PK_KEY_ID_TO_NAME[KEY_CH]
    if options.enable_mapping_requirements == 1:
    ...
    # Council Building
    key_item_name = PK_KEY_ID_TO_NAME[KEY_CB]
    if options.enable_mapping_requirements == 1:
    ...
    # Court House
    key_item_name = PK_KEY_ID_TO_NAME[KEY_CHC]
    if options.enable_mapping_requirements == 1:
    ...
    # Danchi
    key_item_name = PK_KEY_ID_TO_NAME[KEY_D]
    if options.enable_mapping_requirements == 1:
    ...
    key_item_name = PK_KEY_ID_TO_NAME[KEY_DFE]
    if options.enable_mapping_requirements == 1:
    ...
    # Gardens
    key_item_name = PK_KEY_ID_TO_NAME[KEY_G]
    if options.enable_mapping_requirements == 1:
    ...
    # K. HX's Workshop
    key_item_name = PK_KEY_ID_TO_NAME[KEY_KHX]
    if options.enable_mapping_requirements == 1:
    ...
    # Mountain Gorge
    key_item_name = PK_KEY_ID_TO_NAME[KEY_MG]
    if options.enable_mapping_requirements == 1:
    ...
    # Opulent Ziggurat
    key_item_name = PK_KEY_ID_TO_NAME[KEY_OZ]
    if options.enable_mapping_requirements == 1:
    ...
    # Paradise Gates
    key_item_name = PK_KEY_ID_TO_NAME[KEY_PG]
    if options.enable_mapping_requirements == 1:
    ...
    # Pyramid
    key_item_name = PK_KEY_ID_TO_NAME[KEY_P]
    if options.enable_mapping_requirements == 1:
    ...
    key_item_name = PK_KEY_ID_TO_NAME[KEY_RFD]
    if options.enable_mapping_requirements == 1:
    ...
    # Secret Corridor
    connect(world.player, "O-to-SC", regions["Overworl"], regions["Secret Corridor"])
    connect(world.player, "SC-to-O", regions["Secret Corridor"], regions["Overworld"])
    
    # Syndicate Apartments
    key_item_name = PK_KEY_ID_TO_NAME[KEY_SA]
    if options.enable_mapping_requirements == 1:
    ...
    # Syndicate Graveyard
    key_item_name = PK_KEY_ID_TO_NAME[KEY_SG]
    if options.enable_mapping_requirements == 1:
    ...
    # Syndicate HQ
    key_item_name = PK_KEY_ID_TO_NAME[KEY_SHQ]
    if options.enable_mapping_requirements == 1:
